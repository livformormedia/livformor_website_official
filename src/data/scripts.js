...
// ─────────────────────────────────────────────────
// KAP B2B ADS (NEWLY ADDED)
// ─────────────────────────────────────────────────
export const KAP_B2B_SCRIPTS = [
    {
        id: 'KAP-1',
        title: 'B2B Performance Offer for KAP',
        category: SCRIPT_CATEGORIES.CASH_PAY,
        awareness: AWARENESS_LEVELS.SOLUTION,
        framework: FRAMEWORKS.DIRECT,
        outfit: OUTFITS.A,
        duration: '60–90s',
        hooks: [
            { angle: 'Integration Pain Point', text: 'Ketamine-Assisted Psychotherapists: If you’re spending 80% of your initial consultations explaining the difference between true clinical integration and a standard IV drip, your marketing is fundamentally broken.' },
            { angle: 'Software vs. Hardware', text: 'Ketamine-Assisted Psychotherapists: You became a therapist to facilitate actual breakthroughs—but right now, you\'re exhausted from spending months on traditional talk therapy with patients who really need a hardware reset before the software can work.' },
            { angle: 'Prescriber Bottleneck', text: 'If you are a Ketamine-Assisted Psychotherapist: You finally got your training, you understand the protocols, but the operational friction of setting up the medical side and actually getting qualified patients in the chair is burning you out.' },
            { angle: 'Ethical Dilemma', text: 'As a Ketamine-Assisted Psychotherapist, you probably despise "marketing"—it feels transactional. But keeping a modality that pulls people out of TRD in weeks a secret isn\'t ethical either.' },
            { angle: 'Exhausted Intake', text: 'Calling all Ketamine-Assisted Psychotherapists: Are you acting as a full-time educator? If your leads don\'t understand the cash investment before the call, you\'re going to burn out before you ever scale.' },
            { angle: 'Paradigm Shift', text: 'Message for Ketamine-Assisted Psychotherapists: The hardest part of introducing ketamine into a psychotherapy practice isn\'t the clinical work. It\'s shifting patients\' understanding from "taking a daily pill" to "investing in a transformative experience."' },
            { angle: 'Solo Ceiling', text: 'As a solo Ketamine-Assisted Psychotherapist, you have the capacity to change lives, but you\'re competing against massive IV clinics with huge ad budgets. Here is how you beat them.' },
            { angle: 'Direct 1', text: 'Calling all Ketamine-Assisted Psychotherapists: if your marketing agency treats you like a standard IV drip clinic, they are actively costing you patients.' },
            { angle: 'Direct 2', text: 'If you are a licensed Ketamine-Assisted Psychotherapist, here is exactly why your consultation calendar isn\'t full.' },
            { angle: 'Direct 3', text: 'Are you a Ketamine-Assisted Psychotherapist struggling to connect with high-intent cash-pay patients?' },
            { angle: 'Direct 4', text: 'If you run a Ketamine-Assisted Psychotherapy practice, stop buying shared internet leads immediately.' },
            { angle: 'Direct 5', text: 'Ketamine-Assisted Psychotherapists: here is the exact patient acquisition model that beats traditional marketing agencies.' },
            { angle: 'Direct 6', text: 'Attention Ketamine-Assisted Psychotherapists: here is why standard Facebook ads are ruining your intake process.' },
            { angle: 'Direct 7', text: 'If you integrate Ketamine-Assisted Psychotherapy into your private practice, this message is specifically for you.' }
        ],
        body: `We're looking for 5 Ketamine-Assisted Psychotherapists who are struggling to fill their calendar to try a breakthrough patient-acquisition model that shows an 85% qualification rate.\n\nIf you've tried 3+ marketing agencies without landing high-intent patients, this might be for you.\n\nHere's what we know:\nGeneric lead generation works for about 30-40% of standard MedSpas.\n\nBut if you're in the 60-70% of mental health professionals who don't see results from standard ads?\nYou're told to spend more on ad budget.\nOr that there's a problem with the algorithm.\nYou're told to "test new creatives" and do all that stuff.\nIt's exhausting.\n\nBut here's the thing most marketing agencies won't tell you:\nIf 3+ agencies haven't worked, the problem isn't that you haven't found the "right" Facebook ad yet.\n\nThe problem is that marketing Ketamine-Assisted Psychotherapy needs a different approach entirely.\n\nStandard agencies treat your profound clinical work like a discount IV infusion clinic. They generate low-intent leads who think it's a party drug or who instantly balk at the out-of-pocket cash price.\n\nIt's completely friction-heavy.\nWasted intake calls. No-shows. Flaky leads. Time wasted explaining the difference between an SSRI and neuroplasticity to someone who just wanted a quick fix.\nJust 20-30 minute consultations where you sit comfortably trying to sell, instead of doing the clinical work.\n\nThat's where the LivForMor Performance Model comes in.\n\nAnd our results?\n85% of the inquiries we generate for our partner clinics are pre-educated, financially qualified, and clinically appropriate.\n\nMost practitioners notice changes within 1-2 weeks.\nThings like:\n• Waking up without the anxiety of an empty clinical calendar\n• Having the energy to actually focus on patient integration\n• Not being irritable or overwhelmed by following up with dead leads\n\nWe see the solo practitioner who was crippled by operational friction start treating patients at their peak again.\n\nAt LivForMor, our mission isn't just to send you "leads." It's to provide a breakthrough in how patients find you. Because our ultimate goal is to help 100,000 people beat treatment-resistant depression. And we need elite clinicians to do it.\n\nSo here's why we're reaching out:\nWe're looking for 5 Ketamine-Assisted Psychotherapists who:\n✓ Have tried 3+ generic marketing approaches without lasting relief\n✓ Are still struggling to consistently acquire cash-pay patients\n✓ Are open to trying a performance-based, risk-free acquisition model\n✓ Want to finally break free from the cycle of bad retainers\n\nIf that's you, we'd like to offer you a free Practice Growth Assessment to see if you're a good fit for our Performance Model.\nNo pressure. No commitment.\nJust a conversation about whether this system could work for your specific practice.\n\nHere's what you need to know:\n• We only charge $99 per *qualified* inquiry.\n• You pay zero monthly retainers.\n• You define what "qualified" means for your practice.\n• There are no long-term contracts holding you hostage.\n• We only partner with one clinic per market.\n\nThis isn't experimental. It's a proven system that's been filling clinics for over a year. But most practitioners have never heard of it because agencies default to prescribing standard monthly retainers.\n\nIf you're tired of waiting for the "right" agency to work…\nIf you're exhausted from lead-gen side effects that make running your practice harder…\nIf you're ready to partner with someone who actually understands the clinical nuances of KAP…\n\nClick the link below to book your free Practice Growth Assessment.\nThis could be the breakthrough your practice has been looking for.\n\nP.S. If you have colleagues who are struggling to scale their KAP practice despite trying multiple agencies, please share this with them. This model has changed clinics' lives—it could change theirs too.`,
        cta: "Click the link in bio. Book your free Practice Growth Assessment.",
    },
    {
        id: 'KAP-2',
        title: 'The "Different Modality" Educational Offer',
        category: SCRIPT_CATEGORIES.CASH_PAY,
        awareness: AWARENESS_LEVELS.PROBLEM,
        framework: FRAMEWORKS.OCPB,
        outfit: OUTFITS.B,
        duration: '45–60s',
        hooks: [
            { angle: 'Direct Challenge', text: 'Ketamine-Assisted Psychotherapists — if your current marketing agency is treating you like a standard IV infusion clinic, they are actively costing you patients.' },
            { angle: 'Curiosity', text: 'If you run a Ketamine-Assisted Psychotherapy practice, here is why standard Facebook ads are generating low-intent leads who just want a cheap IV drip.' },
        ],
        body: `You already know that the breakthrough happens in the integration, not just the medicine. But generic marketers don't understand that. They run standard Facebook ads for "Ketamine Therapy," generating low-intent leads who are just price-shopping for an IV drip. It exhausts your intake team and forces you to constantly justify the cost of the psychotherapy component.\n\nMarketing a profound modality like KAP requires an education-first patient journey. We’ve seen this across dozens of clinics—when you shift from "selling a treatment" to "educating on the breakthrough," your conversion rate doubles. We partner exclusively with mental health professionals to build these systems. \n\nBut we only work with practitioners who are serious: you need at least $100 a day in ad budget, you must have LegitScript certification, and you must be willing to put your face on camera because stock photos don't build therapeutic trust.\n\nOur mission is to help 100,000 people beat treatment-resistant depression, and we need elite KAP practitioners to do it.`,
        cta: "If you want a patient acquisition system built specifically for the nuances of Ketamine-Assisted Psychotherapy, click the link in my bio. Answer four quick questions, and let's see if we're a fit.",
    },
    {
        id: 'FV-KAP-1',
        title: 'The "Burnout" Empathy Mirror (Founder Voice)',
        category: SCRIPT_CATEGORIES.FOUNDER,
        awareness: AWARENESS_LEVELS.PROBLEM,
        framework: FRAMEWORKS.STORY,
        outfit: OUTFITS.C,
        duration: '45–60s',
        hooks: [
            { angle: 'Deep Empathy', text: 'Ketamine-Assisted Psychotherapists: you became a psychotherapist to facilitate real breakthroughs, but right now, you’re probably feeling the weight of clinical burnout.' },
            { angle: 'The Truth', text: 'If you are a Ketamine-Assisted Psychotherapist, I know exactly why scaling your life-changing modality feels completely impossible right now.' }
        ],
        body: `You have patients with severe PTSD and treatment-resistant depression. You’ve been doing traditional talk therapy with them for months, maybe years, and the needle just isn’t moving. That’s exactly why you integrated Ketamine-Assisted Psychotherapy into your practice. You wanted to give them that hardware-level reset.\n\nBut here is the tragic irony. You have this transformative modality, but scaling it feels impossible. You despise "salesy" marketing. You don't want to run aggressive ads. You just want to connect with the patients who desperately need this intervention.\n\nWhat you need isn't "lead generation." You need an education-first patient journey. You need a system that sits between the noise of the internet and your consultation calendar—a system that educates a struggling patient on why KAP works when SSRIs failed, so that by the time you speak with them, they already trust you.\n\nWe are on a mission to reach 100,000 people suffering from treatment-resistant depression. We can't do that without practitioners like you expanding your capacity.`,
        cta: "If you run a KAP practice and you want to scale it ethically and predictably, send me a DM with the word PRACTICE and I'll show you exactly how our system works.",
    },
    {
        id: 'ORG-KAP-1',
        title: 'Therapy vs. Infusion Distinction (Organic)',
        category: SCRIPT_CATEGORIES.ORGANIC,
        awareness: AWARENESS_LEVELS.UNAWARE,
        framework: FRAMEWORKS.EDUCATIONAL,
        outfit: OUTFITS.A,
        duration: '45s',
        hooks: [
            { angle: 'Direct Callout', text: 'If you offer Ketamine-Assisted Psychotherapy, here is the number one marketing mistake that is destroying your calendar.' },
            { angle: 'The Mistake', text: 'Attention Ketamine-Assisted Psychotherapists: If you are marketing the medicine instead of the integration, you are commoditizing your entire practice.' }
        ],
        body: `You are marketing the medicine, not the integration. Let me explain. When a patient searches for ketamine, they are usually comparing prices for a standard IV infusion clinic. If your website and your content look exactly like theirs, you commoditize yourself.\n\nYou are a licensed psychotherapist. You provide clinical integration, meaning you actually help them process the neuroplasticity that the medicine unlocks.\n\nYour content needs to aggressively highlight the difference between a "software patch" like an SSRI, a standard Ketamine infusion, and true Ketamine-Assisted Psychotherapy. You have to explain to the patient that the medicine opens the door, but the therapy walks them through it.\n\nIf you don't explain that distinction clearly, you will spend all your intake calls defending your highly-justified pricing against a discount IV clinic down the street.`,
        cta: "If you need help articulating this to attract high-intent, cash-pay patients, follow my page for more breakdowns on scaling KAP clinics.",
    }
];
