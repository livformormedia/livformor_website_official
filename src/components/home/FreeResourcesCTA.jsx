    ...
    <section className="py-20 bg-gradient-to-br from-teal-600 to-blue-700">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 lg:p-12 shadow-2xl text-center max-w-3xl mx-auto"
        >
          {/* Icon */}
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white px-10 py-4 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 group"
          >
