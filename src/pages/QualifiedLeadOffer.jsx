                ...
                <FadeIn>
                    <div style={{ textAlign: 'center', marginBottom: 64 }}>
                        ...
                        <p style={{
                            ...
                            Tap each letter below to explore
                        </p>
                    </div>
                </FadeIn>
            ...
            <div onClick={e => e.stopPropagation()} style={{
                ...
                <div style={{ padding: '24px 28px 28px' }}>
                    ...
                    <h2 style={{ fontSize: 22, fontWeight: 700, color: BRAND.dark, marginBottom: 6, fontFamily: 'Georgia,serif' }}>
                        {step === 1 ? 'Get Your Custom KAP Patient Acquisition Plan' : 'Your Contact Details'}
                    </h2>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                                        {[
                                            { value: 'kap', label: 'Ketamine-Assisted Psychotherapy (KAP)' },
                                            { value: 'ketamine', label: 'IV Ketamine Infusions' },
                                            { value: 'tms', label: 'TMS Therapy' },
                                            { value: 'spravato', label: 'Spravato (with Ascension Model)' },
                                        ].map(t => (
                                            <div key={t.value} style={optionCard(formData.services.includes(t.value))}
                                                ...
                                                <span style={{ color: '#374151', fontWeight: 500, fontSize: 13 }}>{t.label}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
            ...
            <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
                ...
                <div style={{ marginTop: 40, textAlign: 'center' }}>
                    <button onClick={onAssessmentClick} style={{
                        ...
                        color: BRAND.dark, fontWeight: 700, border: 'none', borderRadius: 50,
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 18 }}>
                            Get Your Custom KAP Patient Acquisition Plan <ArrowRight size={20} />
                        </div>
                        <span style={{ fontSize: 14, fontWeight: 600, opacity: 0.8 }}>No Cost, No Obligation</span>
                    </button>
                </div>
            </div>
...
const FAQ_DATA = [
    ...
    },
    {
        ...
        a: 'Click "Get Your Custom KAP Patient Acquisition Plan" to complete a short assessment. If your clinic is a good fit, we\'ll schedule a strategy call to walk through your goals, review your current marketing, and outline a custom plan. The onboarding process takes about 5–7 business days from start to first ad live.',
    },
];
...
// ═══════════════════════════════════════════════════════════
// MAIN QUALIFIED LEAD KAP OFFER PAGE
// ═══════════════════════════════════════════════════════════
export default function QualifiedLeadOffer() {
        ...
        <div style={{ fontFamily: "'Nunito Sans', Georgia, serif", color: '#111827' }}>
            ...
            <section style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Stethoscope size={16} color={BRAND.gold} /> Exclusively for KAP, Spravato and TMS Clinics
                    </div>
                    ...
                    <h1 style={{
                        ...
                        Scale Your KAP Practice Without The Risk:<br />
                        <span style={{ color: BRAND.gold }}>Premium Patients, No Retainers, Pay Only For Results</span>
                    </h1>

                    <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.8)', maxWidth: 700, margin: '0 auto 40px', lineHeight: 1.6 }}>
                        KAP clinics are filling their calendars with premium patients while only paying for qualified inquiries that match their exact criteria.
                    </p>
            ...
            <section id="pricing" style={{ padding: '96px 24px', background: 'white' }}>
                <div style={{ maxWidth: 1000, margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <div style={{ width: 80, height: 4, background: BRAND.gold, margin: '0 auto 16px' }} />
                    <p style={{ fontSize: 18, color: '#6b7280', maxWidth: 700, margin: '0 auto 48px', lineHeight: 1.6 }}>
                        Most KAP clinic owners have been burned by marketing retainers - paying thousands upfront with no guaranteed results. Our performance model completely reverses that risk. We invest our time, expertise, and infrastructure first. You only pay when we deliver pre-qualified, treatment-ready patients who match your exact criteria. No retainers, no setup fees, no long-term contracts.
                    </p>
                        ...
                        <div style={{ flex: '1 1 400px', display: 'flex', flexDirection: 'column' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 24 }}>
                                <div style={{
                                    ...
                                    <div style={{ fontSize: 18, fontWeight: 700, color: '#374151', marginBottom: 8 }}>Per Qualified KAP Inquiry</div>
                                    <p style={{ fontSize: 14, color: '#6b7280', margin: 0, lineHeight: 1.5 }}>Only paid when a real, pre-screened prospect - who meets the exact criteria you define for your practice - is delivered to your pipeline.</p>
                                </div>

                                <div style={{
                                    background: BRAND.dark, border: `2px solid ${BRAND.gold}`, borderRadius: 16, padding: 32,
                                    position: 'relative', overflow: 'hidden', color: 'white', textAlign: 'left'
                                }}>
                                    <div style={{
                                    ...
                                    <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)', margin: 0, lineHeight: 1.5 }}>We sit down before launch and agree on exactly what a qualified inquiry means. Cash-pay. Trusting. If it doesn't meet that standard, you don't pay.</p>
                                </div>
                            </div>

                            <div style={{ marginTop: 24, padding: '20px', background: '#f8f9fb', borderRadius: 12, border: '1px solid #e5e7eb', textAlign: 'center' }}>
                                <p style={{ fontSize: 16, fontWeight: 700, color: BRAND.dark, margin: 0 }}>
                                    If a lead doesn't meet our agreed qualification standard, you pay nothing. Period. No fine print, no exceptions.
                                </p>
                            </div>
                        </div>

                        <div style={{ flex: '1 1 400px', borderRadius: 24, overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.12)' }}>
                            <img src="/clinic_dashboard.png" alt="KAP Clinic Patient Acquisition Dashboard" style={{ width: '100%', height: 'auto', display: 'block' }} />
                        </div>
                    </div>
            ...
            <section style={{ padding: '96px 24px', background: 'white' }}>
                <div style={{ maxWidth: 1000, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: 64 }}>
                        ...
                        <div style={{ width: 80, height: 4, background: BRAND.gold, margin: '0 auto' }} />
                    </div>

                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24 }}>
                        {[
                            { value: '14 Days', desc: 'Average time to first qualified KAP inquiry' },
                            { value: '45-60%', desc: 'Typical conversion rate from qualified inquiry to consultation' },
                            { value: '$3,000-$5,000+', desc: 'Average patient value for standard KAP treatment package' },
                            { value: '300%', desc: 'What our clinic partners typically see on their advertising spend' }
                        ].map((stat, i) => (
                            <div key={i} style={{
                                padding: 32, borderRadius: 16, border: `2px solid ${BRAND.teal}20`,
                                background: '#fafafa', textAlign: 'center', transition: 'transform 0.3s',
                                display: 'flex', flexDirection: 'column', justifyContent: 'center'
                            }}>
                                <div style={{ fontSize: 'clamp(28px, 6vw, 36px)', wordBreak: 'break-word', fontWeight: 800, color: BRAND.teal, marginBottom: 12, lineHeight: 1.1 }}>{stat.value}</div>
                                <div style={{ fontSize: 15, color: '#4b5563', lineHeight: 1.5, fontWeight: 600 }}>{stat.desc}</div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section style={{ padding: '96px 24px', background: '#fafafa' }}>
                <div style={{ maxWidth: 1000, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: 64 }}>
                        <h2 style={{ fontSize: 36, fontWeight: 700, color: BRAND.dark, marginBottom: 12, fontFamily: 'Georgia,serif' }}>
                            The 3 Pillars of Patient Acquisition
                        </h2>
                        <div style={{ width: 80, height: 4, background: BRAND.gold, margin: '0 auto 16px' }} />
                        <p style={{ fontSize: 18, color: '#6b7280', maxWidth: 700, margin: '0 auto', lineHeight: 1.6 }}>
                            We don't just run ads. We install a complete patient acquisition infrastructure designed specifically for high-ticket cash-pay clinics.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: 'Sending paid traffic to your homepage is a mistake. Every extra link bleeds your conversion rate. We build dedicated, psychology-driven landing pages that speak directly to the patient\'s exact suffering - and convert.',
                            },
                            {
                                step: '02',
                                title: 'The 5-Minute Response Window',
                                desc: 'MIT research shows that after 5 minutes, your odds of reaching a patient inquiry drop by 80%. We install automated, immediate follow-up systems that engage patients the exact moment they ask for help.',
                            },
                            {
                                step: '03',
                                title: 'The 7-Touch Nurture Sequence',
                                desc: 'A patient considering ketamine for treatment-resistant depression who says "let me think about it" is scared, not gone. Our system automatically follows up 7+ times to stay with the scared ones until they are ready.',
                            }
                        ].map((pillar, i) => (
                            <div key={i} style={{
                                background: 'white', padding: 40, borderRadius: 16, border: '1px solid #e5e7eb',
                                ...
                                <div style={{
                                    fontSize: 64, fontWeight: 900, color: 'rgba(197,184,150,0.15)',
                                    position: 'absolute', top: 20, right: 20, fontFamily: 'Georgia,serif', lineHeight: 1
                                }}>{pillar.step}</div>
                                <h3 style={{ fontSize: 22, fontWeight: 700, color: BRAND.dark, marginBottom: 16, position: 'relative' }}>{pillar.title}</h3>
                                <p style={{ fontSize: 16, color: '#4b5563', lineHeight: 1.6, position: 'relative' }}>{pillar.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section style={{ padding: '96px 24px', background: 'white' }}>
                <div style={{ maxWidth: 900, margin: '0 auto' }}>
                    <h2 style={{
                        ...
                        Why KAP & Premium Clinics Choose Us
                    </h2>
                    <div style={{ width: 80, height: 4, background: BRAND.gold, margin: '0 auto 48px' }} />

                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 64, alignItems: 'center' }}>
                        <div style={{ flex: '1 1 400px', borderRadius: 24, overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.12)' }}>
                            <img src="/kap_therapy_session.png" alt="Patient undergoing Ketamine-Assisted Psychotherapy session" style={{ width: '100%', height: 'auto', display: 'block' }} />
                        </div>
                        <div style={{ flex: '1 1 400px', display: 'grid', gridTemplateColumns: 'minmax(250px, 1fr)', gap: 24 }}>
                            {[
                                { icon: <DollarSign size={24} />, title: 'Zero Risk', desc: 'No retainers, no setup fees. You invest in ad spend - we invest our time and tech. We only get paid when you grow.' },
                                { icon: <Target size={24} />, title: 'KAP Specialists', desc: 'We exclusively serve clinics doing Ketamine-Assisted Psychotherapy and TMS. Our copy sells the therapy and transformation, not just the molecule.' },
                                { icon: <Users size={24} />, title: '5-Minute Follow-Up', desc: 'MIT research shows lead conversion drops 80% after 5 minutes. We deploy automated follow-up infrastructure that instantly engages patients.' },
                                { icon: <Zap size={24} />, title: 'Speed To Patient', desc: 'Most clients see their first booked KAP consultation within 72 hours of launch. We move fast because our revenue depends on your success.' },
                            ].map((item, i) => (
                                <div key={i} style={{
                                    ...
                                    <p style={{ fontSize: 15, color: '#6b7280', margin: 0, lineHeight: 1.6 }}>{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <section style={{ padding: '96px 24px', background: 'white' }}>
                <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <p style={{ fontSize: 18, color: '#6b7280', maxWidth: 600, margin: '0 auto 48px' }}>
                        We only accept KAP and premium TMS clinics where we're confident we can deliver exceptional results.
                    </p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24, maxWidth: 800, margin: '0 auto' }}>
                        <div style={{ background: '#f0fdf4', border: '2px solid #bbf7d0', borderRadius: 16, padding: 28, textAlign: 'left' }}>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, fontSize: 15, color: '#374151' }}>
                                {[
                                    'You offer Ketamine-Assisted Psychotherapy (KAP) or TMS',
                                    'Your clinic is currently operational',
                                    'You have $3,000+/mo for ad spend',
                                    'You are LegitScript certified (or willing to get it)',
                                    'The clinic owner is willing to show their face on camera',
                                ].map((item, i) => (
                        ...
                        <div style={{ background: '#fef2f2', border: '2px solid #fecaca', borderRadius: 16, padding: 28, textAlign: 'left' }}>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, fontSize: 15, color: '#374151' }}>
                                {[
                                    'You run a basic IV hydration lounge without mental health support',
                                    'Your ad budget is under $3,000/month',
                                    'You are unwilling to follow a 5-minute response protocol',
                                ].map((item, i) => (
                                    <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 10 }}>
            ...
            <section style={{
                ...
                <div style={{ maxWidth: 700, margin: '0 auto' }}>
                    <div style={{
                        ...
                        Limited Capacity - We're Currently Accepting Just 4 New KAP Clinics This Month
                    </div>
                    <h2 style={{ fontSize: 32, fontWeight: 700, marginBottom: 16, fontFamily: 'Georgia,serif' }}>
                        Ready To Fill Your Calendar With Premium KAP Patients - Without The Risk Of Retainers?
                    </h2>
            ...
            {showFloatingCTA && (
                <div style={{
                    ...
                    <button onClick={openModal} style={{
                        padding: '12px 32px', background: `linear-gradient(135deg, ${BRAND.gold}, ${BRAND.goldDark})`,
                        color: BRAND.dark, fontWeight: 700, border: 'none', borderRadius: 50,
